...
LEFT JOIN hss_upazillas ON hss_organizations.upazila_code=hss_upazillas.upazilla_id where hss_organizations.email='".$user_email."'");
              ...
              <tr>
               <td align="center" valign="middle">
				...
				Report on<br>
				 ...
				 <span style="color:#000; font-weight: bold;">Report Period: <?php echo $answer_storage_month_year; ?></span><br>
    ...
    <div class="fullpage" style="height:2700px;">
    	...
    	<fieldset>
            ...
            <div class="preface"><div class="widget-content"> 
                        ...
                        <?php 
						   ...
						   <?php
							echo '<b>'.$question_types['type_name'].'</b>';
