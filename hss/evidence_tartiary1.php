...
<tr>
<form action="multiple_upload_ac_tartiary.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
<td>
...
<tr>
<td>Select file jpeg/jpg
<input name="ufile[]" type="file" id="ufile[]" size="50" accept="image/jpeg" /></td>
</tr>
<tr>
<td>Select file jpeg/jpg
<input name="ufile[]" type="file" id="ufile[]" size="50" accept="image/jpeg" /></td>
