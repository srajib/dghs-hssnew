 ...
 $tree = mysql_query("SELECT * from admin_division");
    ...
    while($row = mysql_fetch_array($tree))
    {
        ...
        <?php
			...
			<div class="spane6" > 
                            <div class="control-group" style="alignment-adjust: central"><h3>Upozilla Summary Report <h3></div>
                            
			<table class='table'>
			  <tbody>
			    <th> Question Type </th><th>Answer count</th><th> Sept </th><th>Oct</th><th>Nov</th><th>December</th>
			  </tbody>
			  <tr>
                            <td width="200px"><h5><strong> Cleanliness<strong> </h5></td>
                          </tr>
                          <tr>
                              <td > Q1 </td><td> Yes </td><td>20</td><td> 30</td><td> 0 </td><td> 0 </td>
			  </tr>
			  <tr>
				<td> Q2 </td><td>Yes </td><td>10</td><td> 25</td><td> 0 </td><td> 0 </td>
			  </tr>
                           <tr>
				<td> Q3 </td><td> Yes </td><td>25</td><td> 45</td><td> 0 </td><td> 0 </td>
			  </tr>
                           <td width="200px"><h5><strong> Waste management System<strong></h6></td>
                          </tr>
                          <tr>
				<td> Q1 </td><td> Yes </td><td>20</td><td> 30</td><td> 0 </td><td> 0 </td>
			  </tr>
