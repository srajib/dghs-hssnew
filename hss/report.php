								...
								{   $i++;
								  ...
								  $answers = mysql_query("SELECT * FROM hss_answers_tertiary where answer_q_id=$qid");
									...
									if ($ev[0]==NULL)
									     ...
									     <?php }else{ ?><a href="upload/<?php echo $ev[0];?>" title="Showing Large Image. $('#gallery').lightBox();"><img src="upload/<?php echo $ev[0];?>" width="50" height="50"></a>&nbsp;<?php }  
								 	echo '';
									$path2 =$url1.'q_'.$qid.'_'.$org_code.'_'.$answer_storage_month_year.'_2.gif';
									$imgurl_check2 = $path2;
								   if ($ev[1]==NULL)
										  { ?><img src="images/no.jpg" width="50" height="50">&nbsp;
									     <?php }else{ ?><a href="upload/<?php echo $ev[1];?>" title="Showing Large Image . $('#gallery').lightBox();"><img src="upload/<?php echo $ev[1];?>" width="50" height="50"></a>&nbsp;<?php }  
								 	echo '';
								 ...
								 if ($ev[2]==NULL)
										  { ?><img src="images/no.jpg" width="50" height="50">
									     <?php }else{ ?><a href="upload/<?php echo $ev[2];?>" title="Showing Large Image . $('#gallery').lightBox();"><img src="upload/<?php echo $ev[2];?>" width="50" height="50"></a><?php } 
								 	echo '</div>';
