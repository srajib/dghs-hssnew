...
$id =$_REQUEST['id'];
$result = mysql_query("SELECT * FROM hss_questions WHERE question_id= '$id'");
$test = mysql_fetch_array($result);
if (!$result) 
		{
		die("Error: Data not found..");
		}
				$question_desc=$test['question_desc'] ;

if(isset($_POST['save']))
{	
	$question_desc_save = $_POST['question_desc'];
	mysql_query("UPDATE hss_questions SET question_desc='$question_desc_save' WHERE question_id = '$id'")
	or die(mysql_error()); 
	//echo "Saved!";
 print "<script>";
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="span6">
				...
				<tr>
				<td>Question:</td>
				<td><input type="text" name="question_desc" value="<?php echo $question_desc ?>"/></td>
				</tr>
				<tr>
				<td>&nbsp;</td>
