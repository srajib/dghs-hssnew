			...
			<ul class="nav">
				...
				<li class="dropdown">					
					...
					<ul class="dropdown-menu">							
						<li><a href="./login.html">Basic Report</a></li>
						<li class="dropdown">
							<a href="javascript:;">
								Report									
			...
			<script>
				...
				$.ajax({                                      
				  ...
				  { 
					...
					if(vname > 0)
					{
					  	$('#output').html("<b>You already inserted this month data.You can only update data.<br><a id='myanchorid' href='org_add.php'>Please click here to update new datas.</a></b>"); //Set output element html
