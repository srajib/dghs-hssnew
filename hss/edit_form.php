...
$id =$_REQUEST['id'];
$result = mysql_query("SELECT * FROM hss_forms WHERE form_id= '$id'");
...
{	
	...
	mysql_query("UPDATE hss_forms SET form_name='$form_name_save' WHERE form_id = '$id'")
	or die(mysql_error()); 
	//echo "Saved!";
 print "<script>";
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="span6">
				...
				<tr>
				<td>Form Name:</td>
				<td><input type="text" name="form_name" value="<?php echo $form_name;?>"/></td>
				</tr>
				<tr>
				<td>&nbsp;</td>
