...
$_FILES['userfile']['name'][0]='q_'.$q_id.'_'.$org_code.'_'.$month.'_1'.'.'.(substr($_FILES['userfile']['type'][0], -4));
}else
{
$_FILES['userfile']['name'][0]='q_'.$q_id.'_'.$org_code.'_'.$month.'_1'.'.'.(substr($_FILES['userfile']['type'][0], -3));
}
