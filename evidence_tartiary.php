...
//                        for($i=1;$i<4;$i++){
  ...
  if(!empty($file1)){
   $sql=  mysql_query("UPDATE hss_tertiary_answer_storage SET answer_storage_q".$q_id."_evidence1='$file1',answer_storage_modified='$datetime' where answer_storage_org_id='$org_code' AND answer_storage_month_year='$month' AND answer_storage_q".$q_id."='$q_id'");
   }
   if(!empty($file2)){
    $sql=  mysql_query("UPDATE hss_tertiary_answer_storage SET answer_storage_q".$q_id."_evidence2='$file2',answer_storage_modified='$datetime' where answer_storage_org_id='$org_code' AND answer_storage_month_year='$month' AND answer_storage_q".$q_id."='$q_id'");   
   }
   if(!empty($file3)){
    $sql=  mysql_query("UPDATE hss_tertiary_answer_storage SET answer_storage_q".$q_id."_evidence3='$file3',answer_storage_modified='$datetime' where answer_storage_org_id='$org_code' AND answer_storage_month_year='$month' AND answer_storage_q".$q_id."='$q_id'");    
   }
