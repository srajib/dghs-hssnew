...
<body>
	<div class="demo">     
			<h2>Start uploading manually Test.....</h2>
...
if($fileguidlist)
{
	...
	//		echo($mvcfile->FilePath);
			echo("</div>");
			$file1=$mvcfile->FileName;
                        //echo "moly $file ";
			//Moves the uploaded file to a new location.
			$mvcfile->MoveTo("uplodsImage/".$file1);
                        $array=array($file1);
                        //print_r($array);
                       echo $arimp=implode(",",$array);
                        
                                               
//                    //$exception_field=array('myuploader');
//			//echo $str=createMySqlUpdateString($_POST, $exception_field);
//                       
//                     $sql=  mysql_query("update hss_upload set $str where id='1' ");
                   //$sql=mysql_query("insert into hss_upload(path1)values('$file1')");
