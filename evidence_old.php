...
<body>
	...
	<div class="container">			
		...
		<div style="height:100px; width:auto;"><img src="img/logo.png" style="height:80px; width:95px; border:none"><font style="font-family:'Arial Black', Gadget, sans-serif; font-size:25px;position:relative; bottom:15px; color:#CCC">Health System Strengthing</font><br>
...
<div id="content">
	...
	<div class="container">
		...
		<div class="row"><h1>Evidence upload is off till 18-12-13 12:00pm.</h1> 

			<!--
			<div class="span6">
			    Please select Evidence1
				<input type="file" name="evidence1">
				<br/>
				Please select Evidence2
				<input type="file" name="evidence2">
				<br/>
				Please select Evidence3
				<input type="file" name="evidence3">
			</div>  /.span6
			-->
