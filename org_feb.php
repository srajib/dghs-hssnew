...
$answer_storage_month_year='02-2013';
...
$tree = mysql_query("SELECT * from admin_division");
 ...
 <div class="spane7" style="alignment-adjust: central"><h3>Upazila Report </h3></div>
 <p>
<div class="spane6" > 
...
//                        print_r(questionReturn($qid));
                      ...
                      echo '<div style="width:800px">'.$i.'. '. $qa[1]. '&nbsp;&nbsp;&nbsp;&nbsp;';
                        ...
                        while($answer = mysql_fetch_assoc($answers))
                        {
                         ...
                         if($answer1==$ans){ echo '------------ Answer : '.$answer1.'   ------------  <strong>February:</strong> 1';}
                         else{ echo '------------ Answer : '.$answer2.'  ------------  <strong>February :</strong> 0';}
